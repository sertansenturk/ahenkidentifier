...
def identify(tonic_freq, symbol_in):
    ...
    wrapped_cent_approx = int(np.round(wrapped_cent_dist * 0.01) * 100)
...
def hz_to_cent(hz_track, ref_freq):
    ...
    ----------------------------------------------------------------------------
    :param ref_freq: Reference frequency for cent conversion
    :param hz_track: The 1-D array of Hertz values
    -------------------------------------------------------------------------"""
